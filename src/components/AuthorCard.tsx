    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-6 mt-12'>
            <div className='flex items-center animation-fadeIn'>
                <Image
                    className='w-16 h-20 rounded-xl mr-4 object-cover border-2 border-slate-700'
                    src='/images/pic.jpg' // Image ka path Next.js mein `/public` folder ke andar hota hai
                    alt='Author Image'
                    width={64} // Image ka width specify karen
                    height={80} // Image ka height specify karen
                />
            ...
            <div className='mt-4 flex space-x-3'>
                <a href="https://www.facebook.com/profile.php?id=100008668830856"                     className='px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 transition duration-300 hover:scale-95'>

                        Facebook
                    
                </a>

                <a href="https://github.com/Ahmed-Abrar123" className='px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 transition duration-300 hover:scale-95'>
                    
                        GitHub
                    
                </a>

                <a href="https://www.linkedin.com/in/m-ahmed-abrar-691b0726a" className='px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 transition duration-300 hover:scale-95'>
